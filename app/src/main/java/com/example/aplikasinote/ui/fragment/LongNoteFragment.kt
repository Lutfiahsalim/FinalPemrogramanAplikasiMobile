package com.example.aplikasinote.ui.fragment
...
import com.example.aplikasinote.ui.viewModel.NoteViewModel
import com.example.aplikasinote.util.Utilities.toEditable
import kotlinx.android.synthetic.main.default_note_fragment.*

class LongNoteFragment<NoteViewModel>(private var _defaultNote: DefaultNote? = null) : Fragment() {
    companion object {
        const val TAG: String = "LongNoteFragment"
        private const val BUNDLE_NOTE_ID = "bundle_note_id"

        fun newInstance(id: Long): LongNoteFragment<Any> {
            val longNoteFragment = LongNoteFragment<Any>()
            val bundle = Bundle()
    ...
    private lateinit var noteViewModel: com.example.aplikasinote.ui.viewModel.NoteViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        noteViewModel = ViewModelProvider(this)
            .get(com.example.aplikasinote.ui.viewModel.NoteViewModel::class.java)
